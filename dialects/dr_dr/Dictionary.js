...
"honlli": new Noun("honlli", 1, {'Irrational': 'berry or small fruit as part of a plant', 'Magical': 'berry or small fruit as part of a plant', 'Mundane': 'berry or small fruit as food; treat, snack; morcel'}, ""),
...
"q̇o": new Noun("q̇o", 3, {'Abstract': 'surprise, shock'}, ""),
...
"trō": new Noun("trō", 1, {'Mundane': 'tooth'}, ""),
...
"ural": new Noun("ural", 1, {'Abstract': 'nonsense, gibberish'}, ""),
...
COMMON.PHRASES.MAP ={
"óħá": new Phrase("óħá", "Hello (informal)", ""),
"qēr'an": new Phrase("qēr'an", "Hello (formal)", ""),
"thā": new Phrase("thā", "Goodbye (informal)", ""),
"qerun": new Phrase("qerun", "Goodbye (formal)", ""),
"ti synciχo (keχħô)": new Phrase("ti synciχo (keχħô)", "Please (to a dragon)", "literally 'if you can (be generous)'part in parentheses is optional/extra formal"),
"ti syciχo (keχħô)": new Phrase("ti syciχo (keχħô)", "Please (to a human)", "literally 'if you can (be generous)'part in parentheses is optional/extra formal"),
"synkēχħô": new Phrase("synkēχħô", "Thank you (to a dragon)", "literally 'you are a generous dragon'"),
"sykēχħô": new Phrase("sykēχħô", "Thank you (to a human)", "literally 'you are a generous person'"),
"tuz sun": new Phrase("tuz sun", "You're welcome (to a dragon)", "literally 'the same as you'"),
"tuz suf": new Phrase("tuz suf", "You're welcome (to a human)", "literally 'the same as you'"),
"xef'ekfūh": new Phrase("xef'ekfūh", "Sorry; Excuse me (human)", "literally 'I am regretful'"),
"trōlq": new Phrase("trōlq", "Yes", "rare; it is much more common to simply repeat back the verb in the affirmative, e.g.Q: Do you eat meat?A: I eat"),
"q̇yth": new Phrase("q̇yth", "No", "somewhat rare; it is more common to simply repeat back the verb in the negative, e.g.Q: Do you eat meat?A: I do not eat"),
"xeftrilqo": new Phrase("xeftrilqo", "I (human) know", ""),
"ax xeftrilqo": new Phrase("ax xeftrilqo", "I (human) don't know", ""),
"hoχoq̇ hantoq̇ ħásuf?": new Phrase("hoχoq̇ hantoq̇ ħásuf?", "What's your (human) name?", ""),
"tolūrχ hantoq̇ ħáxyf ___": new Phrase("tolūrχ hantoq̇ ħáxyf ___", "My (human) name is___", ""),
"xef'ærχ qēfun": new Phrase("xef'ærχ qēfun", "Nice to meet you (of a human, to a dragon)", "literally 'I am pleased before you'"),
"xef'ærχ qēfuf": new Phrase("xef'ærχ qēfuf", "Nice to meet you (of a human, to a human)", "literally 'I am pleased before you'"),
"hóqħ nyl sycoktiz?": new Phrase("hóqħ nyl sycoktiz?", "How are you (human) doing?", "literally 'How do you fly?'"),
"xefqo": new Phrase("xefqo", "I (human) am doing well", "literally 'I fly true'"),
"ax xefqo": new Phrase("ax xefqo", "I (human) am not doing well", "literally 'I don't fly true'"),
"si sun?": new Phrase("si sun?", "What about you? (to a dragon)", ""),
"si suf?": new Phrase("si suf?", "What about you? (to a human)", ""),
"hóqħ tōrūlōq̇sytrôqħúq̇?": new Phrase("hóqħ tōrūlōq̇sytrôqħúq̇?", "What languages do you (human) speak?", ""),
"ax xeftrôqħúq̇ itræχnâħyq̇": new Phrase("ax xeftrôqħúq̇ itræχnâħyq̇", "I (human) don't speak Draconic", ""),
"xeftrôqħúq̇ ___": new Phrase("xeftrôqħúq̇ ___", "I (human) speak ___", ""),
"xefkēlliqχo": new Phrase("xefkēlliqχo", "I (human) understand", ""),
"ax xefkēlliqχo": new Phrase("ax xefkēlliqχo", "I (human) don't understand", ""),
"hoχoq̇ tolūrχ ___ qχok'itræχnâħyq̇?": new Phrase("hoχoq̇ tolūrχ ___ qχok'itræχnâħyq̇?", "What is ___ in Draconic?", ""),
"hoqħôq̇ tososoq ___": new Phrase("hoqħôq̇ tososoq ___", "What does ___ mean?", ""),
"hóqħ hōkoq̇ sytrekeq̇?": new Phrase("hóqħ hōkoq̇ sytrekeq̇?", "Where are you (human) from?", ""),
"xeftrekeq̇ ___": new Phrase("xeftrekeq̇ ___", "I (human) am from ___", ""),
"xef'ærχ ___": new Phrase("xef'ærχ ___", "I (human) like ___", "verb suffix will depend on gender of object"),
"ax xef'ærχ ___": new Phrase("ax xef'ærχ ___", "I (human) dislike ___", "verb suffix will depend on gender of object"),
"syr sy'ærχ ___": new Phrase("syr sy'ærχ ___", "Do you (human) like ___?", "verb suffix will depend on gender of object"),
"xefsal ___?": new Phrase("xefsal ___?", "I (human) would like ___", "verb suffix will depend on gender of object"),
"syr sysal ___?": new Phrase("syr sysal ___?", "Would you (human) like ___?", "verb suffix will depend on gender of object"),
"xefχarû": new Phrase("xefχarû", "I (human) want ___", "verb suffix will depend on gender of object"),
"syrak quru'": new Phrase("syrak quru'", "Wait! (to a human)", ""),
"syrak χu'lu": new Phrase("syrak χu'lu", "Help! (to a human)", ""),
"trā": new Phrase("trā", "Wow! Nice! Cool!", ""),
"q̇ħó": new Phrase("q̇ħó", "Oh! (surprise)", ""),
"xy...": new Phrase("xy...", "Uh…", ""),
"hox?": new Phrase("hox?", "What? Huh?", ""),
"syrak lur feltūlef": new Phrase("syrak lur feltūlef", "Good luck! (to a human)", "literally 'be lucky!'"),
"xeflliχuf": new Phrase("xeflliχuf", "I love you (human to human)", "platonic/familial"),
"xefllēluf": new Phrase("xefllēluf", "I love you (human to human)", "romantic, passionate"),
"hārmoq̇ χarχyq̇": new Phrase("hārmoq̇ χarχyq̇", "Good morning/good day", ""),
"kuχūq̇ χarχyq̇": new Phrase("kuχūq̇ χarχyq̇", "Good night", ""),
"syr syqo?": new Phrase("syr syqo?", "Are you okay?", "literally 'Do you fly true?'"),
"thūq̇ feŋqχōq̇": new Phrase("thūq̇ feŋqχōq̇", "It's alright/No worries", "literally 'insignificant issues'")
}
    
COMMON.PROVERBS.MAP ={
"āhak tōq̇ hāq̇": new Proverb("āhak tōq̇ hāq̇", "to waste one's time, to attempt the impossible", "literally 'to reach for the stars'"),
"sæxtyk texyllerk": new Proverb("sæxtyk texyllerk", "unfortunate circumstance outside one's control, especially if innate (i.e. genetic)", "literally 'thick eggshell.' Refers to the false, superstitious belief that thicker eggshells yield underdeveloped hatchlings"),
"ēzā thūllērerk": new Proverb("ēzā thūllērerk", "to have one's head in the clouds", "literally 'to gaze into water' "),
"ēħôq̇ħúχ mūχ": new Proverb("ēħôq̇ħúχ mūχ", "performance anxiety", "literally 'wet flamebox'"),
"tōrūlhuχ χyxadōχ": new Proverb("tōrūlhuχ χyxadōχ", "a deadgiveaway, a smoking gun", "literally 'forked tongue.' When dragons use transformation music to take the form of humans, unless they are highly skilled, the tongue will remain forked and serpentine "),
"harōrk mōrk": new Proverb("harōrk mōrk", "squandered opportunity, wasted potential", "literally 'wet tinder'"),
"lūrox saχōrk": new Proverb("lūrox saχōrk", "to waste time on something trivial/meaningless; to be a tryhard", "literally 'to hoard copper'")
}
