...
"axa": {1: new Noun("axa", 1, {'Abstract': 'negativity; negation'}, ""),2: new Noun("axa", 2, {'Monstrous': 'eyebat; cyclops', 'Abstract': 'sight, vision'}, "")},
...
"cyfox": new Noun("cyfox", 2, {'Magical': 'nutrient', 'Abstract': 'sustenance, nutrition; potency; essence, quality'}, ""),
...
"cī": new Noun("cī", 3, {'Irrational': 'herb, especially for culinary use'}, ""),
"ehsen": new Noun("ehsen", 3, {}, ""),
"erχ": new Noun("erχ", 2, {'Abstract': 'surroundings'}, ""),
"feru": new Noun("feru", 3, {'Magical': 'sedative; anesthesia', 'Mundane': 'milk; nectar', 'Abstract': 'drowsiness, sleepiness; sedation'}, ""),
"feŋkxō": new Noun("feŋkxō", 1, {'Abstract': 'infancy (nondragon)'}, ""),
...
"fēltū": new Noun("fēltū", 1, {'Irrational': 'farm animal', 'Magical': 'uncontrollable laughter', 'Mundane': 'cheese', 'Abstract': 'cheeriness, gaiety; luck, good fortune'}, " the sense 'Draconic name' has become increasingly rare in the modern day"),
"fōlnty": new Noun("fōlnty", 3, {'Abstract': 'regularity, order; sequence; cleanliness'}, ""),
"fōxeh": new Noun("fōxeh", 3, {'Magical': 'sacrificial item, offering', 'Abstract': 'embarassment; failure, rejection'}, " sense 'corpse, carcass' can never refer to the corpse of an Exalted being"),
...
"fūrχ": new Noun("fūrχ", 2, {'Abstract': 'direction; linearity; Directive'}, ""),
...
"hanto": new Noun("hanto", 3, {'Exalted': 'individual', 'Rational': 'individual', 'Monstrous': 'individual', 'Irrational': 'individual', 'Abstract': 'name; personality'}, ""),
...
"harārō": new Noun("harārō", 2, {'Magical': '(definite) The Abyss', 'Abstract': 'Abyssal (language)'}, ""),
...
"hexto": new Noun("hexto", 1, {'Abstract': 'north'}, ""),
...
"honi": new Noun("honi", 1, {'Mundane': 'fruit or vegetable as food', 'Abstract': 'vegetarianism, herbivorism'}, ""),
...
"hā": new Noun("hā", 1, {'Abstract': 'quintessence'}, " typically classed as animate when referring to specific souls, and in the Magical when discussing souls generally"),
"hāreχ": new Noun("hāreχ", 2, {'Abstract': 'heating; temperature'}, ""),
...
"ifū": new Noun("ifū", 1, {'Exalted': 'spitter, that which spits', 'Rational': 'spitter, that which spits', 'Monstrous': 'spitter, that which spits', 'Irrational': 'llama', 'Abstract': 'spitting'}, ""),
...
"kax": new Noun("kax", 2, {'Abstract': 'char, burning'}, ""),
...
"kxēlkxēl": new Noun("kxēlkxēl", 3, {'Exalted': 'lightning dragon, storm dragon', 'Magical': 'lightning'}, ""),
...
"kēx": new Noun("kēx", 1, {'Exalted': 'phoenix', 'Rational': 'any winged humanoid', 'Monstrous': 'harpy', 'Irrational': 'any winged animal other than a bird', 'Abstract': 'winged flight'}, " in the Irrational, the term typically refers to creatures that have been magically bestowed wings that otherwise wouldn't have them"),
"kōru": new Noun("kōru", 2, {'Abstract': 'metal as a material'}, ""),
"kōrū": new Noun("kōrū", 1, {'Monstrous': 'amalgam, amalgamation', 'Irrational': 'robot; golem, especially of metal', 'Abstract': 'fusion, blending; the creation of alloys; the process of amalgamation'}, ""),
"kōthuŋ": new Noun("kōthuŋ", 3, {'Exalted': 'builder, constructor; worker', 'Rational': 'builder, constructor; worker', 'Monstrous': 'builder, constructor; worker', 'Irrational': 'builder, constructor; worker', 'Abstract': 'building, construction (process); theoretical structure'}, ""),
...
"llefāχ": new Noun("llefāχ", 1, {'Mundane': 'support structure', 'Abstract': 'religious faith'}, ""),
...
"llerēχ": new Noun("llerēχ", 1, {'Exalted': 'roommate, flatemate, housemate', 'Rational': 'roommate, flatemate, housemate', 'Monstrous': 'roommate, flatemate, housemate', 'Irrational': 'roommate, flatemate, housemate', 'Abstract': 'cohabitation'}, ""),
...
"llifuχō": new Noun("llifuχō", 1, {'Abstract': 'faith, trust'}, ""),
...
"lliqa": new Noun("lliqa", 3, {'Exalted': 'flyer, that which flies', 'Rational': 'flyer, that which flies', 'Monstrous': 'flyer, that which flies', 'Irrational': 'bird', 'Abstract': 'flight, the ability to fly'}, ""),
...
"llâŋ": new Noun("llâŋ", 3, {'Abstract': 'agreement; consent'}, ""),
"llæfāre": new Noun("llæfāre", 3, {'Magical': 'connection, bond', 'Mundane': 'connection, bond', 'Abstract': 'idea; theory'}, ""),
"llôχħô": new Noun("llôχħô", 1, {'Mundane': 'forge', 'Abstract': 'smithing; metallurgy'}, ""),
...
"llēlī": new Noun("llēlī", 1, {'Abstract': 'romance, espeically passionate romance', 'Magical': 'romantic, passionate love; uncontrollable love'}, ""),
"llēr": new Noun("llēr", 1, {'Magical': 'elixir; any magical liquid', 'Mundane': 'water; body of water'}, ""),
...
"llēħ": new Noun("llēħ", 4, {'Abstract': 'transportation'}, ""),
...
"llīlχħá": new Noun("llīlχħá", 4, {'Magical': 'fey sprite or wisp', 'Mundane': 'trick', 'Abstract': 'whimsy; fey energy'}, ""),
...
"lâl": new Noun("lâl", 4, {'Abstract': 'inanimacy'}, ""),
...
"lōx": new Noun("lōx", 2, {'Irrational': 'unicorn', 'Abstract': 'siren, alarm call'}, ""),
"lūryχ": new Noun("lūryχ", 3, {'Abstract': 'continuity'}, ""),
"meχ": new Noun("meχ", 3, {'Mundane': 'coin', 'Abstract': 'tin as a material; coinage'}, ""),
"mâ": new Noun("mâ", 4, {'Exalted': 'divine being; divinetouched', 'Rational': 'divine being; divinetouched', 'Monstrous': 'divine being; divinetouched', 'Irrational': 'divine being; divinetouched', 'Magical': 'divine magic, especially as wielded by gods', 'Abstract': 'divinity; (definite, plural) The Pantheon; the gods as a whole'}, ""),
...
"naltæ": new Noun("naltæ", 2, {'Abstract': 'way, method, means; strategy; instruction'}, " sense 'recipe, instructions' only in the magical for alchemical or ritualistic instructions"),
...
"oχħó": new Noun("oχħó", 4, {'Exalted': 'fighter, soldier', 'Rational': 'fighter, soldier', 'Monstrous': 'fighter, soldier', 'Irrational': 'fighter, soldier', 'Magical': 'playfighting, especially among dragons', 'Mundane': 'bruise', 'Abstract': 'battle, physical struggle; physical violence'}, ""),
...
"qar": new Noun("qar", 1, {'Abstract': '(figurative) heart; core, center'}, " in the Mundane, sense 'heart' is strictly anatomical, whereas in the Magical, it typically refers more to sensation or emotion"),
...
"qyzelleŋ": new Noun("qyzelleŋ", 3, {'Exalted': 'medic', 'Rational': 'medic', 'Monstrous': 'medic', 'Irrational': 'plant with healing properties', 'Magical': 'natural healing magic', 'Mundane': 'medicinal equipment', 'Abstract': 'equality, equal rights; reciprocation'}, ""),
...
"qû": new Noun("qû", 4, {'Abstract': 'swordsmanship'}, ""),
...
"qērx": {2: new Noun("qērx", 2, {'Exalted': 'merchant, shopkeep', 'Rational': 'merchant, shopkeep', 'Monstrous': 'merchant, shopkeep', 'Irrational': 'merchant, shopkeep', 'Abstract': 'trade; economy'}, ""),3: new Noun("qērx", 3, {'Magical': 'prophesization magic', 'Abstract': 'prediction'}, "")},
"qērxaχ": new Noun("qērxaχ", 1, {'Exalted': 'prophet; oracle', 'Rational': 'prophet; oracle', 'Monstrous': 'prophet; oracle', 'Irrational': 'prophet; oracle', 'Abstract': 'prophesy'}, ""),
"qħón": new Noun("qħón", 3, {'Magical': 'tail', 'Mundane': 'tail'}, ""),
"qħôn": new Noun("qħôn", 3, {'Mundane': 'tentacle; appendage'}, ""),
"qūllēl": new Noun("qūllēl", 3, {'Exalted': 'captain, head navigator', 'Rational': 'captain, head navigator', 'Monstrous': 'captain, head navigator', 'Irrational': 'captain, head navigator', 'Magical': 'compass', 'Mundane': 'star chart for navigational purposes', 'Abstract': 'navigation'}, ""),
...
"q̇ehax": new Noun("q̇ehax", 2, {'Rational': 'dwarf', 'Abstract': 'dwarvenkind'}, ""),
"q̇ehā": new Noun("q̇ehā", 2, {'Mundane': 'chunk, piece', 'Abstract': 'clause, phrase; section, portion'}, ""),
"q̇erō": new Noun("q̇erō", 1, {'Abstract': 'south'}, ""),
...
"q̇u'o": new Noun("q̇u'o", 4, {'Abstract': 'digestion; pondering, deep thought'}, ""),
"q̇ħónlli": new Noun("q̇ħónlli", 1, {'Mundane': 'finger, digit, claw', 'Abstract': 'number, numeral; count'}, ""),
"q̇ħôlli": new Noun("q̇ħôlli", 1, {'Mundane': 'pond, lake'}, ""),
...
"q̇ūhīn": new Noun("q̇ūhīn", 1, {'Abstract': 'reframing, reinterpretation, reassessment; allergy'}, ""),
...
"qχēl": new Noun("qχēl", 1, {'Magical': 'dragon scale', 'Abstract': 'resilience; toughness, resistance, material strength'}, ""),
...
"seq̇": new Noun("seq̇", 4, {'Exalted': 'term of endearment', 'Rational': 'term of endearment', 'Monstrous': 'term of endearment', 'Irrational': 'term of endearment', 'Abstract': 'giving, donation, charity'}, ""),
...
"sirtell": new Noun("sirtell", 1, {'Monstrous': 'Cancer (mythology)', 'Irrational': 'crustacean; (by extension) snail, any shelled creature', 'Abstract': 'safety, security'}, ""),
...
"syχħû": new Noun("syχħû", 4, {'Abstract': 'example; instance, incident'}, ""),
"sáħ": new Noun("sáħ", 1, {'Rational': 'swimmer; any aquatic lifeform', 'Exalted': 'swimmer; any aquatic lifeform', 'Monstrous': 'swimmer; any aquatic lifeform', 'Irrational': 'swimmer; any aquatic lifeform', 'Mundane': 'oar, paddle', 'Abstract': 'merfolkkind, merfolk as a group; a swim, swimming; the ability to swim'}, ""),
"sæntox": new Noun("sæntox", 3, {'Exalted': 'creator, especially of life', 'Rational': 'creator, especially of life', 'Monstrous': 'creator, especially of life', 'Irrational': 'creator, especially of life', 'Magical': 'lifegiving magic, animative magic', 'Abstract': 'actualization, realization; nominalization; personification; animation'}, ""),
"særxēl": new Noun("særxēl", 1, {'Irrational': 'animated armor', 'Abstract': 'protection, defense, especially in combat'}, ""),
...
"sēχħú": new Noun("sēχħú", 4, {'Exalted': 'experimentalist; scientist', 'Rational': 'experimentalist; scientist', 'Monstrous': 'experimentalist; scientist', 'Irrational': 'experimentalist; scientist', 'Abstract': 'try, attempt; experiment; science'}, ""),
"sīl": new Noun("sīl", 3, {'Magical': '(definite) the Dragon Plane', 'Mundane': 'den, housing', 'Abstract': 'home'}, ""),
"sōqaχ": new Noun("sōqaχ", 4, {'Abstract': 'artistry, art'}, ""),
...
"tharχ": new Noun("tharχ", 1, {'Magical': 'prayer', 'Mundane': 'prayerbook', 'Abstract': 'ask, inquiry, question; praying'}, ""),
...
"thulqā": new Noun("thulqā", 2, {'Abstract': 'west'}, ""),
...
"thulχā": new Noun("thulχā", 2, {'Abstract': 'east'}, ""),
"thutrûllīqu": new Noun("thutrûllīqu", 1, {'Exalted': 'a creature which sustains itself via the consumption of blood', 'Rational': 'a creature which sustains itself via the consumption of blood', 'Monstrous': 'vampire (in bat form)', 'Irrational': 'vampire bat', 'Mundane': 'syringe', 'Abstract': 'vampirism; the practice of drinking blood'}, ""),
"thæf": new Noun("thæf", 1, {'Magical': 'wing, especially of a dragon', 'Mundane': 'wing; limb', 'Abstract': 'side, flank; edge, ridge; extent, degree'}, ""),
"thō": new Noun("thō", 4, {'Exalted': 'guard, guardian', 'Rational': 'guard, guardian', 'Monstrous': 'guard, guardian', 'Irrational': 'guard, guardian', 'Abstract': 'issue, problem, obstacle; security'}, ""),
...
"tirx": new Noun("tirx", 2, {'Abstract': 'complexity, difficulty'}, ""),
...
"trellelleŋ": new Noun("trellelleŋ", 3, {'Abstract': 'value, worth'}, ""),
"trexēk": new Noun("trexēk", 1, {'Abstract': 'consumption, voracity, greed; gluttony'}, ""),
"trexēxō": new Noun("trexēxō", 1, {'Exalted': 'biological consumer', 'Rational': 'biological consumer', 'Monstrous': 'biological consumer', 'Irrational': 'biological consumer'}, ""),
"treχō": new Noun("treχō", 3, {'Abstract': 'use, utilization'}, ""),
...
"tryχaχu": new Noun("tryχaχu", 1, {'Exalted': 'escapee', 'Rational': 'escapee', 'Monstrous': 'escapee', 'Irrational': 'escapee', 'Abstract': 'escape; escapism'}, ""),
...
"tuŋllīlâ": new Noun("tuŋllīlâ", 1, {'Exalted': 'pantheon; collection of gods', 'Abstract': 'kabal, syndicate, faction; organization, collective, union; society'}, ""),
...
"tōrūl": new Noun("tōrūl", 3, {'Abstract': 'language'}, ""),
...
"xæn": new Noun("xæn", 3, {'Abstract': 'deference, respect'}, ""),
...
"xærī": new Noun("xærī", 2, {'Irrational': 'shrub, fern, bush', 'Magical': 'wand', 'Mundane': 'branch; stick, twig'}, ""),
...
"āxaχ": new Noun("āxaχ", 1, {'Exalted': 'actor; doer, agent; player', 'Rational': 'actor; doer, agent; player', 'Monstrous': 'actor; doer, agent; player', 'Irrational': 'actor; doer, agent; player', 'Abstract': 'agency; activity'}, ""),
...
"ē'ēkfūh": new Noun("ē'ēkfūh", 3, {'Magical': 'apocalypse, armageddon; mass destruction', 'Mundane': 'apocalypse, armageddon; mass destruction', 'Abstract': 'apocalypse, armageddon; mass destruction'}, ""),
"ē'ū": new Noun("ē'ū", 2, {'Abstract': 'sound; audio; phone (linguistics)'}, ""),
"ēfū": new Noun("ēfū", 1, {'Exalted': 'shooter, that which shoots', 'Rational': 'shooter, that which shoots', 'Monstrous': 'shooter, that which shoots', 'Irrational': 'shooter, that which shoots', 'Abstract': 'firing, shooting; (in the plural) fire, barrage, volley'}, ""),
"ēglōχ": new Noun("ēglōχ", 1, {'Exalted': 'archer', 'Rational': 'archer', 'Monstrous': 'archer', 'Irrational': 'archer', 'Abstract': 'archery'}, ""),
"ēglū": new Noun("ēglū", 1, {'Exalted': 'extraplanar exaltant; celestial', 'Magical': 'rainbow', 'Abstract': 'arc, arch'}, ""),
"ēhā": new Noun("ēhā", 2, {'Exalted': 'regent, king or queen', 'Rational': 'regent, king or queen', 'Monstrous': 'regent, king or queen', 'Irrational': 'regent, king or queen', 'Abstract': 'dominance, control'}, ""),
"ēhō": new Noun("ēhō", 2, {'Monstrous': 'banshee', 'Magical': 'voicebox', 'Mundane': 'voice', 'Abstract': 'noise, clamor, ruckus; shriek; volume, sonority'}, ""),
"ēkfūh": new Noun("ēkfūh", 3, {'Abstract': 'loss, tragedy, despair'}, ""),
...
"ēχ": new Noun("ēχ", 4, {'Magical': 'twinspell', 'Mundane': 'pair', 'Abstract': 'double, duality, dyad; dual'}, ""),
"ēχsen": new Noun("ēχsen", 3, {'Abstract': 'lycanthropy'}, ""),
"ħatrū": new Noun("ħatrū", 1, {'Abstract': 'lightness, delicacy'}, ""),
"ħyh": new Noun("ħyh", 4, {'Abstract': 'gold as a material; affluence, wealth'}, ""),
"ħárχħôrχ": new Noun("ħárχħôrχ", 4, {'Exalted': 'winner', 'Rational': 'winner', 'Monstrous': 'vampire (in human form)', 'Irrational': 'griffin', 'Magical': 'acid rain', 'Mundane': 'prize; medal, trophy; rain', 'Abstract': 'success, accomplishment; arrival, landing'}, ""),
"ħâ": new Noun("ħâ", 2, {'Magical': 'flame; fire breath', 'Mundane': 'flame; fire breath'}, ""),
"ħâ'": new Noun("ħâ'", 3, {'Irrational': 'animal', 'Abstract': 'vulnerability'}, ""),
"ħâno": new Noun("ħâno", 4, {'Exalted': 'cannibal', 'Rational': 'cannibal', 'Monstrous': 'ghoul; any flesheating monster', 'Irrational': 'personification of blight, decay', 'Mundane': 'flesh, especially rotten', 'Abstract': 'cannibalism; blight, decay'}, " often abscribed as an insult"),
"ħâq̇": new Noun("ħâq̇", 1, {'Abstract': 'esteem, exaltation, admiration'}, ""),
"ħóz": new Noun("ħóz", 3, {'Magical': 'snowstorm', 'Mundane': 'snow, frost; snowflake', 'Abstract': 'cold'}, ""),
"ħô": new Noun("ħô", 1, {'Magical': 'hail; sleet', 'Mundane': 'ice, ice crystal', 'Abstract': 'iciness, slipperiness'}, ""),
"ħôħ": new Noun("ħôħ", 4, {'Exalted': 'ice dragon', 'Irrational': 'any creature native to snowy environments', 'Magical': 'blizzard; avalanche', 'Mundane': 'tundra, snowy expanse', 'Abstract': 'bitter and unbearable cold'}, ""),
"ħôŋ": new Noun("ħôŋ", 3, {'Rational': 'humanoid, any humanlike creature', 'Irrational': 'golem, especially of stone', 'Mundane': 'statue'}, ""),
"ħúħû": new Noun("ħúħû", 1, {'Exalted': 'one who is abnormally large', 'Rational': 'giant', 'Monstrous': 'one who is abnormally large', 'Irrational': 'one who is abnormally large', 'Abstract': 'giantkind, giants as a group'}, ""),
"ħûl": new Noun("ħûl", 3, {'Mundane': 'corner, nook, cranny', 'Abstract': 'angle'}, ""),
"ħāxaχ": new Noun("ħāxaχ", 1, {'Exalted': 'predator, especially a vicious one', 'Rational': 'predator, especially a vicious one', 'Monstrous': 'predator, especially a vicious one', 'Irrational': 'predator, especially a vicious one'}, ""),
"īk": new Noun("īk", 3, {'Magical': 'magical resource', 'Mundane': 'natural resource', 'Abstract': 'resource'}, ""),
"ōciqāχu": new Noun("ōciqāχu", 1, {'Exalted': 'genius', 'Abstract': 'intelligence, knowledge'}, ""),
...
"ōrn": new Noun("ōrn", 1, {'Abstract': 'containment'}, ""),
...
"ōχfāled": new Noun("ōχfāled", 3, {'Exalted': 'prisoner', 'Rational': 'prisoner', 'Monstrous': 'prisoner', 'Irrational': 'prisoner', 'Magical': 'force cage', 'Abstract': 'imprisonment'}, ""),
"ōχħó": new Noun("ōχħó", 4, {'Irrational': 'porcupine; cactus', 'Magical': 'thagomizer', 'Mundane': 'spike, prong', 'Abstract': 'lash, tailstrike'}, ""),
"ōχōraħ": new Noun("ōχōraħ", 4, {'Exalted': 'crowd, group', 'Rational': 'crowd, group', 'Monstrous': 'crowd, group', 'Irrational': 'crowd, group', 'Abstract': 'collecting, collection'}, ""),
"ūk": new Noun("ūk", 3, {'Abstract': 'fall, sinking, descent; latency, delay, regression; Recessive'}, ""),
...
"χa": new Noun("χa", 2, {'Abstract': 'trace, impact'}, ""),
...
"χāráħ": new Noun("χāráħ", 4, {'Exalted': '(definite) Yggdrasil', 'Rational': 'sentient tree; (plural) sentient plant life', 'Magical': 'nature magic', 'Abstract': 'nature, in the abstract'}, ""),
"χārô": new Noun("χārô", 4, {'Magical': 'magic wish', 'Mundane': 'treasure', 'Abstract': 'wish, hope'}, ""),
...
"χāŋō": new Noun("χāŋō", 1, {'Mundane': 'corpse', 'Abstract': 'zombies, mindless undead as a goup'}, ""),
...
"χħēhā": new Noun("χħēhā", 2, {'Abstract': 'hierarchy, ranking; class, gender (grammatical)'}, ""),
...
"χōka": new Noun("χōka", 2, {'Abstract': 'reflection, reflectivity'}, ""),
"χōlleql": new Noun("χōlleql", 3, {'Abstract': 'comedy'}, ""),
