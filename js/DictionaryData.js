...
"ħâno4": new Noun("ħâno", 4, {'Exalted': 'cannibal', 'Rational': 'cannibal', 'Monstrous': 'ghoul; any flesh-eating monster', 'Irrational': 'personification of blight, decay', 'Mundane': 'flesh, especially rotten', 'Abstract': 'cannibalism; blight, decay'}, "- often abscribed as an insult"),
...
"kxælli3": new Noun("kxælli", 3, {'Rational': 'any canine humanoid', 'Monstrous': 'any monstrous dog-like creature', 'Irrational': 'dog; wolf', 'Abstract': 'dogkind or wolfkind, dogs or wolves as a group'}, "- does not typically refer to werewolves"),
...
"tuŋ3": new Noun("tuŋ", 3, {'Exalted': 'land-dweller, one who resides on land', 'Rational': 'land-dweller, one who resides on land', 'Monstrous': 'land-dweller, one who resides on land', 'Irrational': 'land-dweller, one who resides on land', 'Magical': 'magic stone; any small stone with magical properties', 'Mundane': 'stone, rock, pebble; dirt', 'Abstract': 'ground; (definite) the Material Plane'}, "- sense 'land-dweller' frequently used by dragons as a pejorative for humanoids"),
...
"xaχō1": new Noun("xaχō", 1, {'Exalted': 'fiersome dragon', 'Monstrous': 'a horror; a monstrosity', 'Magical': 'uncontrollable fear', 'Abstract': 'horror, terror'}, "- sense 'fiersome dragon' is seldom used by dragons, but common among Draconic-speaking humanoids"),
...
"χōfāled1": new Noun("χōfāled", 1, {'Irrational': 'carnivorous plant; tangle of vines or other such plants', 'Magical': 'magical trap, snare; magically activated trigger', 'Mundane': 'mechanical trap, snare', 'Abstract': 'trap, a deceitful arrangement; entrapment'}, "- sense 'carnivorous plant' typically refers to small, flytrap-like plants"),
...
"χħáxul": new Verb("χħáxul", "to transform, to make into", "χħáxūd, χħâxul, χħâxūd", "- result of transformation marked with preposition thū-- can also suffix onto nouns to verbalize them, like '___-ify,' but this is seen as a bit clunky outside of loanwords"),
...
"fel'arq3": new Adjective("fel'arq", 3, "physical, material, structured; non-magical, mundane; Mundane", "fēl'arq", ""),
...
"ifere1": new Adjective("ifere", 1, "drowsy, sleepy; sedative, sleep-inducing; anesthetic", "īfere", ""),
...
"ikēlħá1": new Adjective("ikēlħá", 1, "magically electric; lightning-like; highly energetic", "īkēlħa", ""),
...
"lâ4": new Adjective("lâ", 4, "still, unmoving; dead, non-living", "lārâ", ""),
"lætrāχ2": new Adjective("lætrāχ", 2, "black, brown, dull yellow; murky, brackish; acidic; gross, disgusting, putrid", "lartrāχ", ""),
"lirχħá4": new Adjective("lirχħá", 4, "light-hearted, fun, casual; whimsical, silly", "līrχħá", ""),
...
"qyrōn4": new Adjective("qyrōn", 4, "non-binary; neutral", "qirōn", ""),
...
"u'χħá4": new Adjective("u'χħá", 4, "extensive; all-encompassing; omnipresent; ", "ū'χħá", ""),
...
"ōn": new Particle("ōn", "optional noun suffix on animate roots to specify non-binary/gender neutral", ""),
